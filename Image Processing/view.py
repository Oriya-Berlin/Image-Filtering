...
def main():
    ...
    browse_button = Button(bottom_grid, text="Browse...").grid(row=1, column=0, sticky=W)
    save_button = Button(bottom_grid, text="Save").grid(row=1, column=2, sticky=W)
    ...
    selected_image = ImageTk.PhotoImage(Image.open("images/f1.jpg"))
